...
const drumID myDrum = snare;  // What drum am I?
...
const uint8_t numColors = 7;  // Number of colors:
                              // snares and tenors have 7, basses have 8.
...
volatile uint8_t colorSwitch = 0;
