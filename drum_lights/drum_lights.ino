...
const drumID myDrum = tenor;  // What drum am I?
...
const uint8_t numColors = 3;  // Number of colors:
                              // new: snares and tenors have 3, basses have 2.
                              // old: snares and tenors have 7, basses have 8.

// Threshold value to decide when the detected sound is a knock or not
// 65 for basses and snares; 10-15 for tenors
// Other useful values: 20, 50, 65, 100, 200
