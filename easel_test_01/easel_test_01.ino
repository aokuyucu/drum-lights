...
void display_boxes(uint8_t color1, uint8_t color2, uint8_t color3, uint8_t color4) {
    matrix->clear();
    matrix->drawRect(0,0, mw,mh, color1);
    matrix->drawRect(1,1, mw-2,mh-2, color2);
    matrix->fillRect(2,2, mw-4,mh-4, color3);
    matrix->fillRect(3,3, mw-6,mh-6, color4);
    matrix->show();
}
...
*/
    ...
    */
    ...
    /*
    delay(500);
    display_boxes(LED_ORANGE_MEDIUM, LED_BLUE_HIGH, LED_GREEN_MEDIUM, LED_RED_HIGH);
    delay(500);
    display_boxes(LED_RED_HIGH, LED_ORANGE_MEDIUM, LED_BLUE_HIGH, LED_GREEN_MEDIUM);
    delay(500);
    display_boxes(LED_GREEN_MEDIUM, LED_RED_HIGH, LED_ORANGE_MEDIUM, LED_BLUE_HIGH);
    delay(500);
    display_boxes();
    */
    delay(3000);
